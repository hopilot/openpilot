  ...
  def update(self, c, enabled, CS, frame, actuators, pcm_cancel_cmd, visual_alert,
    ...
    # reset lead distnce after the car starts moving
      ...
      if not self.cruise_gap_adjusting:
        if 0 < CS.lead_distance <= 149 and CS.lead_objspd < 0 self.try_early_stop and \ 
         CS.cruiseGapSet != 4.0 and 0 < self.sm['longitudinalPlan'].e2eX[12] < 100 and self.sm['longitudinalPlan'].stopLine[12] < 100:
