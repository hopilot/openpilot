    ...
    if (!scene.nDebugUi3) {
      if (scene.navi_select == 3) { 
        ...
        switch(scene.liveNaviData.opkrspeedsign) {
            ...
            case 131 or 135 or 150 or 200 or 231:
        ...
        ui_print(s, ui_viz_rx+200, ui_viz_ry+240, "[Stock Navi]");
        ui_print(s, ui_viz_rx+200, ui_viz_ry+280, "SL:%.0f", (*s->sm)["carState"].getCarState().getSafetySign());
        ui_print(s, ui_viz_rx+200, ui_viz_ry+320, "DS:%.0f", (*s->sm)["carState"].getCarState().getSafetyDist());
      } 
